...
export const isParagraphState = (s: TState): s is IParagraphState =>
  s.name === 'paragraph'
export const isAtxHeadingState = (s: TState): s is IAtxHeadingState =>
  s.name === 'atx-heading'
...
export const isCodeBlockState = (s: TState): s is ICodeBlockState =>
  s.name === 'code-block'
export const isHtmlBlockState = (s: TState): s is IHtmlBlockState =>
  s.name === 'html-block'
export const isLinkReferenceDefinitionState = (
  s: TState
): s is ILinkReferenceDefinitionState => s.name === 'link-reference-definition'
export const isMathBlockState = (s: TState): s is IMathBlockState =>
  s.name === 'math-block'
export const isFrontmatterState = (s: TState): s is IFrontmatterState =>
  s.name === 'frontmatter'
export const isDiagramState = (s: TState): s is IDiagramState =>
  s.name === 'diagram'
export const isTableCellState = (s: TState): s is ITableCellState =>
  s.name === 'table.cell'

export const isBlockQuoteState = (s: TState): s is IBlockQuoteState =>
  s.name === 'block-quote'
export const isOrderListState = (s: TState): s is IOrderListState =>
  s.name === 'order-list'
export const isBulletListState = (s: TState): s is IBulletListState =>
  s.name === 'bullet-list'
export const isTableState = (s: TState): s is ITableState => s.name === 'table'
export const isTaskListState = (s: TState): s is ITaskListState =>
  s.name === 'task-list'
export const isTaskListItemState = (s: TState): s is ITaskListItemState =>
  s.name === 'task-list-item'
export const isListItemState = (s: TState): s is IListItemState =>
  s.name === 'list-item'
export const isTableRowState = (s: TState): s is ITableRowState =>
  s.name === 'table.row'
export const isFootnoteBlockState = (s: TState): s is IFootnoteBlockState =>
  s.name === 'footnote'
