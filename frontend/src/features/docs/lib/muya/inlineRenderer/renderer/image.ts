...
export default function image(
  ...
  const imageIcons = [
    renderIcon(h, 'mu-image-icon-success', lucideIcons.image),
    renderIcon(h, 'mu-image-icon-fail', lucideIcons.imageFail),
    renderIcon(h, 'mu-image-icon-close', lucideIcons.delete),
  ]
