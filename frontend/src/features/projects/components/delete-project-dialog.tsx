...
export function DeleteProjectDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-md max-w-[95vw] w-full p-6'>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4 w-full'>
            <DialogHeader>
              ...
              <DialogDescription className='text-xs pt-1'>
                This action is permanent and cannot be undone. Documents inside this project will remain intact as personal drafts.
              </DialogDescription>
            </DialogHeader>
                ...
                <FormItem className='w-full'>
                  ...
                  <FormControl>
                    <Input
                      ...
                      className='h-9 text-xs w-full font-mono'
                      {...field}
                      autoFocus
                    />
                  </FormControl>
